...
public:
	...
	public:
		...
		Vertex(const Vec3& pos, const Vertex& src) : color(src.color), pos(pos) {}
		Vertex(const Vec3& pos, const Color& color) : color(color), pos(pos) {}
	...
	public:
		...
		public:
			...
			Output(const Vec4& pos, const Vertex& src) : color(src.color), pos(pos) {}
			Output(const Vec4& pos, const Color& color) : color(color), pos(pos) {}
