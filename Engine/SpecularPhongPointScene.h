...
public:
	...
	virtual void Draw() override
	{
		...
		pipeline.effect.vs.BindWorld(Mat4::RotationX(theta_x) * Mat4::RotationY(theta_y) * Mat4::RotationZ(theta_z) * Mat4::Translation(0.0f, 0.0f, offset_z) * Mat4::RotationY(phi));
