...
public:
	GeometryFlatScene(Graphics& gfx, IndexedTriangleList<Vertex> tl) : itlist(std::move(tl)), pipeline(gfx), Scene("flat geometry scene free mesh")
	{
	...
	virtual void Draw() override
	{
		...
		const Mat3 rot_phi = Mat3::RotationX(phi_x) * Mat3::RotationY(phi_y) * Mat3::RotationZ(phi_z);
